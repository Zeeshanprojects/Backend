...
const PROMPTS = {
    getFeaturesList: `Generate a list of small basic features only (dont include linebreaks) (only 10) for any provided prompt in an array of objects format with the keys (id, label) only. If the prompt is unrelated, unintelligible, or not relevant, return an empty array`,
